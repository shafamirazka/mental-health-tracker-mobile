      ...
      child: InkWell(
        ...
        onTap: () async {
          ...
          if (item.name == "Tambah Mood") {
            ...
            // Navigasi ke MoodEntryFormPage saat "Tambah Mood" ditekan.
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) =>
                    MoodEntryFormPage(), // Halaman yang ingin dituju
              ),
            );
          } else if (item.name == "Lihat Mood") {
            // Navigasi ke MoodEntryPage saat "Lihat Mood" ditekan
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) =>
                    const MoodEntryPage(), // Halaman yang ingin dituju
              ),
            );
